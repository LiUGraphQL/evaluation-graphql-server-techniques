...
var getAllReviews = function getAllReviews(arg) {
...
function () {
  function ReviewRepository() {
    ...
    _defineProperty(this, "memoizedGetReviewByNr", (0, _helpers.memoize)(getReviewByNr));

    _defineProperty(this, "memoizedGetReviewsByProductNr", (0, _helpers.memoize)(getReviewsByProductNr));

    _defineProperty(this, "memoizedGetAllReviews", (0, _helpers.memoize)(getAllReviews));
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.memoizedGetReviewByNr(nr));
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this.memoizedGetAllReviews("all"));
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                productNr = _ref.product, field = _ref.field, direction = _ref.direction;
                _context3.next = 3;
                return this.memoizedGetReviewsByProductNr(productNr);
              ...
              case 3:
                ...
                return _context3.abrupt("return", reviews.map(function (_ref2) {
                  var nr = _ref2.nr;
                  return {
                    nr: nr
                  };
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 15:
                return _context4.abrupt("return", reviews.map(function (_ref4) {
                  var nr = _ref4.nr;
                  return {
                    nr: nr
                  };
