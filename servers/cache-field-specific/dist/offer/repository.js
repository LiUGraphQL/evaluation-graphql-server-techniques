...
function () {
  function OfferRepository() {
    ...
    _defineProperty(this, "memoizedGetOfferByNr", (0, _helpers.memoize)(getOfferByNr));

    _defineProperty(this, "memoizedGetOfferPricesByNrs", (0, _helpers.memoize)(getOfferPricesByNrs));

    _defineProperty(this, "memoizedGetOffersByVendorNr", (0, _helpers.memoize)(getOffersByVendorNr));

    _defineProperty(this, "memoizedGetOffersByVendorNrs", (0, _helpers.memoize)(getOffersByVendorNrs));

    _defineProperty(this, "memoizedGetOffersByProductNr", (0, _helpers.memoize)(getOffersByProductNr));
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.memoizedGetOfferByNr(nr));
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", this.memoizedGetOfferPricesByNrs(nrs));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return this.memoizedGetOffersByVendorNr(nr);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                offersByProductPromise = this.memoizedGetOffersByProductNr(productNr);
                _context6.next = 5;
