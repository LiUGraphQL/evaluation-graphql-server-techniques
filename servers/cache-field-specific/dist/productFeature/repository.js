...
function () {
  function ProductFeatureRepository() {
    ...
    _defineProperty(this, "memoizedGetProductFeaturesByNrs", (0, _helpers.memoize)(getProductFeaturesByNrs));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                nr = _ref2.nr;
                _context3.next = 3;
                return this.memoizedGetProductFeatureProductsByProductNr(nr);

              case 3:
                productFeatureProducts = _context3.sent;
                return _context3.abrupt("return", this.memoizedGetProductFeaturesByNrs(productFeatureProducts.map(function (pfp) {
