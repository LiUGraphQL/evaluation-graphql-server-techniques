...
var getProductFeaturesByNrs = function getProductFeaturesByNrs(nrs) {
  var query = _database["default"].select().from("productfeature").whereIn("nr", nrs);
...
function () {
  function ProductFeatureRepository() {
    ...
    _defineProperty(this, "memoizedGetProductFeatureByNr", (0, _helpers.memoize)(getProductFeatureByNr));

    _defineProperty(this, "memoizedGetProductFeatureByNrs", (0, _helpers.memoize)(getProductFeaturesByNrs));

    _defineProperty(this, "memoizedGetProductFeatureProductsByProductNr", (0, _helpers.memoize)(getProductFeatureProductsByProductNr));
  }
  ...
  _createClass(ProductFeatureRepository, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.memoizedGetProductFeatureByNr(nr));
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3(_ref) {
        var productNr, productFeatureProducts;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                productNr = _ref.product;
                _context3.next = 3;
                return this.memoizedGetProductFeatureProductsByProductNr(productNr);

              case 3:
                productFeatureProducts = _context3.sent;
                return _context3.abrupt("return", this.memoizedGetProductFeatureByNrs(productFeatureProducts.map(function (pfp) {
