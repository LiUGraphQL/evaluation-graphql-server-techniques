...
var getOffersByVendorNr = function getOffersByVendorNr(vendorNr) {
  var query = _database["default"].select().from("offer").where("vendor", vendorNr);
  ...
  _createClass(OfferRepository, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee6(_where, repos) {
        ...
        var vendors, _ref4, vendorArg, AND, vendorNrs;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                return _context6.abrupt("return", this.memoizedGetOffersByVendorNrs(vendorNrs));
