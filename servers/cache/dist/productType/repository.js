          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return this.memoizedGetProductTypeProductByProductNr(productNr);

              case 3:
                productTypeProduct = _context3.sent;
                return _context3.abrupt("return", this.memoizedGetProductTypeByNr(productTypeProduct.productType));
