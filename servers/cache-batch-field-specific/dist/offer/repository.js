...
var getAllOffers = function getAllOffers(keys) {
  var query = _database["default"].select().from("offer");
...
function () {
  function OfferRepository() {
    ...
    _defineProperty(this, "allOfferLoader", new _dataloader["default"](getAllOffers, {
      cache: _config.cache
    }));
  ...
  _createClass(OfferRepository, [{
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.allOfferLoader.load("all");

              case 2:
                offers = _context2.sent;
                offers.forEach(function (offer) {
                  return _this.offerByNrLoader.prime(offer.nr, offer);
                });
                return _context2.abrupt("return", offers);
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                ...
                return _context5.abrupt("return", offers.filter(function (offer) {
                  return offer.product == productNr;
                }));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                if (vendorArg) {
                  ...
                  AND.forEach(function (_ref5) {
                    ...
                    vendors = _this2.resolveVendorField(vendors, vendorArg);
                  });
                }
              ...
              case 8:
                ...
                offers = offers.flat();
                offers.forEach(function (offer) {
                  return _this2.offerByNrLoader.prime(offer.nr, offer);
                });
    ...
    value: function resolveAndField(query, andInput) {
      ...
      andInput.forEach(function (_ref6) {
        ...
        query = _this3.resolveVendorField(query, vendor);
      });
      return query;
    }
  }, {
