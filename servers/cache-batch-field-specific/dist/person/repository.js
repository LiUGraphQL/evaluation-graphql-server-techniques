...
var getPersonByNrs = function getPersonByNrs(nrs) {
  var uniqueNrs = _lodash["default"].uniq(nrs);

  var query = _database["default"].select().from("person").whereIn("nr", uniqueNrs);
...
function () {
  function PersonRepository() {
    ...
    _defineProperty(this, "personByNrLoader", new _dataloader["default"](getPersonByNrs, {
      cache: _config.cache
    }));
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.personByNrLoader.load(nr));
