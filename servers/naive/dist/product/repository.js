...
var getProductsByNrs = function getProductsByNrs(nrs) {
  var query = _database["default"].select().from("product").whereIn("nr", nrs);
...
var getProductsByProducerNr = function getProductsByProducerNr(producerNr) {
  var query = _database["default"].select().from("product").where("producer", producerNr);
...
var getProductTypeProductByProductType = function getProductTypeProductByProductType(productTypeNr) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", getProductByNr(nr));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", getProductsByProducerNr(producerNr));
              ...
              case 5:
                ...
                _context3.next = 8;
                return getProductTypeProductByProductType(productType);

              case 8:
                productTypeProducts = _context3.sent;
                return _context3.abrupt("return", getProductsByNrs(productTypeProducts.map(function (ptp) {
                  return ptp.product;
                })));
              ...
              case 12:
                ...
                _context3.next = 15;
                return getProductFeatureProductsByProductFeature(productFeature);

              case 15:
                productFeatureProducts = _context3.sent;
                return _context3.abrupt("return", getProductsByNrs(productFeatureProducts.map(function (pfp) {
                  return pfp.product;
                })));
