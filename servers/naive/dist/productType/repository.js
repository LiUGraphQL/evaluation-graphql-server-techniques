  ...
  _createClass(ProductTypeRepository, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", getProductTypeByNr(nr));
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee3(_ref) {
        var productNr, productTypeProduct;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return getProductTypeProductByProductNr(productNr);

              case 3:
                productTypeProduct = _context3.sent;
                return _context3.abrupt("return", getProductTypeByNr(productTypeProduct.productType));
